...
// FILE_DES: auto_vec.hh: Auxiliary
// Heikki Virtanen

// $Id: auto_vec.hh 1.3 Fri, 27 Feb 2004 16:36:58 +0200 warp $
// 
// auto_vec is pointer wrapper, which can be used to own dynamically
// allocated memory (vectors) and to release it automatically.

// $Log: auto_vec.hh,v $
// Revision 1.1  1999/07/13 15:24:55  hvi
// Initial revision
//
